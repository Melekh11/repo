...
* Первые будут обладать уникальными правами: отправлять заявки для совместных мероприятий, отвечать на заявки других соц проектов, создавать события своего соц проекта). 
